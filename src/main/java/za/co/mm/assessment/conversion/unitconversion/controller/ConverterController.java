...
public class ConverterController {
    ...
    //this RequestResponse method Acres Hectare and vice versa    
    @RequestMapping(value="/hectareacres", method = RequestMethod.POST)
    public ResponseEntity<OutputConverterDTO> getHectareAcres(@RequestBody InputConverterDTO converterDTO){                   
        return new ResponseEntity<>(converterService.convertAcresHectare(converterDTO),HttpStatus.OK);
    }    
    ...
    //this RequestResponse method Kilogram Pound and vice versa    
    @RequestMapping(value="/poundkilogram", method = RequestMethod.POST)
    public ResponseEntity<OutputConverterDTO> getPoundKilogram(@RequestBody InputConverterDTO converterDTO){                   
        return new ResponseEntity<>(converterService.convertKilogramPound(converterDTO),HttpStatus.OK);
    }    
    ...
    //this RequestResponse method Kilometer Mile and vice versa    
    @RequestMapping(value="/milekilometer", method = RequestMethod.POST)
    public ResponseEntity<OutputConverterDTO> getMileKilometer(@RequestBody InputConverterDTO converterDTO){                   
        return new ResponseEntity<>(converterService.convertKilometerMile(converterDTO),HttpStatus.OK);
    }    
    //this RequestResponse method Liter Gallon and vice versa    
    @RequestMapping(value="/gallonliter", method = RequestMethod.POST)
    ...
    public ResponseEntity<OutputConverterDTO> getGallonLiter(@RequestBody InputConverterDTO converterDTO){                   
        return new ResponseEntity<>(converterService.convertLiterGallon(converterDTO),HttpStatus.OK);
    }      
